export default function useCountry() {
    ...
    // Data copied from:
    // https://github.com/isvidler/vue3-country-region-select/blob/master/src/data.js
    const data = [
        {
    ...
    function getCountryStatesMap() {
        ...
        data.forEach(country => {
            map[country.countryShortCode] = {};
            country.regions.forEach(region => {
                map[country.countryShortCode][region.shortCode] = region.name;
            });
        });
